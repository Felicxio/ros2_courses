...
class TurtleSpawnerNode(Node): 
    ...
    def spawn_new_turtle(self):
        """
        randomizes where the turtle will spawn, it's an automated function so we can call the spawn service!
        """
    ...
    def call_kill_service(self, turtle_name):
        ...
        future.add_done_callback(partial(self.callback_kill_service, turtle_name=turtle_name))
